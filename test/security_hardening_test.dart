...
void main() {
  ...
  testWidgets('EmrHomeScreen search field has security hardening', (WidgetTester tester) async {
  ...
  testWidgets('StaffDirectoryScreen search field has security hardening', (WidgetTester tester) async {
  ...
  testWidgets('LabOrderScreen clinical notes field has security hardening', (WidgetTester tester) async {
    ...
    expect(notesField.maxLength, 500, reason: 'Lab notes field should have maxLength 500');
    expect(notesField.decoration?.counterText, '', reason: 'Lab notes field should suppress counterText');
  });
}
