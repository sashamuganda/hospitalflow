...
void main() {
  ...
  testWidgets('Search fields have security hardening for input lengths', (WidgetTester tester) async {
    // EMR Home search
  ...
  testWidgets('LabOrderScreen notes have security hardening for input lengths', (WidgetTester tester) async {
