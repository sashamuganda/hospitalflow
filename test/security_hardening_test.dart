...
void main() {
  ...
  testWidgets('LabOrderScreen has security hardening for notes input length', (WidgetTester tester) async {
    ...
    expect(notesField.maxLength, 500, reason: 'Notes field should have maxLength 500');
    expect(notesField.decoration?.counterText, '', reason: 'Notes field should suppress counterText');
  });
  ...
  testWidgets('EmrHomeScreen has security hardening for search input length', (WidgetTester tester) async {
    ...
    expect(searchField.maxLength, 100, reason: 'Search field should have maxLength 100');
    expect(searchField.decoration?.counterText, '', reason: 'Search field should suppress counterText');
  });
