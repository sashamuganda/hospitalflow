...
void main() {
  ...
  testWidgets('StaffDirectoryScreen has security hardening for search input', (WidgetTester tester) async {
    ...
    expect(searchField.maxLength, 100, reason: 'Staff search should have maxLength 100');
    expect(searchField.decoration?.counterText, '', reason: 'Staff search should suppress counterText');
  });
  ...
  testWidgets('LabOrderScreen has security hardening for clinical notes', (WidgetTester tester) async {
    ...
    expect(notesField.maxLength, 500, reason: 'Lab notes should have maxLength 500');
    expect(notesField.decoration?.counterText, '', reason: 'Lab notes should suppress counterText');
  });
}
