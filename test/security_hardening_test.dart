...
void main() {
  ...
  testWidgets('LabOrderScreen has security hardening for notes', (WidgetTester tester) async {
  ...
  testWidgets('EmrHomeScreen has security hardening for search', (WidgetTester tester) async {
  ...
  testWidgets('StaffDirectoryScreen has security hardening for search', (WidgetTester tester) async {
