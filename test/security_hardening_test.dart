...
void main() {
  ...
  testWidgets('LabOrderScreen has security hardening for clinical notes', (WidgetTester tester) async {
    ...
    expect(notesField.maxLength, 500, reason: 'Lab Order notes field should have maxLength 500');
    expect(notesField.decoration?.counterText, '', reason: 'Lab Order notes field should suppress counterText');
  });
}
