...
GoRouter createRouter(AppState appState) {
  return GoRouter(
    ...
    redirect: (context, state) {
      ...
      // 🛡️ RBAC: Route guarding based on user role
      ...
      if (loc.startsWith('/lab')) {
        if (role != StaffRole.nurse && role != StaffRole.labTech) {
          return '/home';
        }
      }
      if (loc.startsWith('/analytics') || loc.startsWith('/staff')) {
        if (role != StaffRole.admin) {
          return '/home';
        }
      }
      if (loc.startsWith('/appointments')) {
        if (role != StaffRole.admin && role != StaffRole.receptionist) {
          return '/home';
        }
      }
      ...
      if (loc.startsWith('/pharmacy') || loc.startsWith('/inventory')) {
