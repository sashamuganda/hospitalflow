...
class KpiCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final semanticLabel = '$value $label${subtitle != null ? ', $subtitle' : ''}';
    return Semantics(
      label: semanticLabel, button: onTap != null, container: true,
...
class MetricCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Semantics(
      label: '$value $unit $label', button: onTap != null, container: true,
      child: GestureDetector(
        onTap: onTap == null ? null : () { HapticFeedback.lightImpact(); onTap!(); },
        child: Container(
