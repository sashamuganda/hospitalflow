...
class _PharmacyHomeScreenState extends State<PharmacyHomeScreen> {
  ...
  Widget build(BuildContext context) {
    // ⚡ Bolt: Cache filtered prescriptions in local variable to avoid O(N^2) complexity in ListView.separated
    final filteredRx = _filtered;
            ...
            children: [
              ...
              Expanded(
                child: ListView.separated(
                  ...
                  itemCount: filteredRx.length,
                  separatorBuilder: (_, __) => const SizedBox(height: 12),
                  itemBuilder: (context, i) =>
                      _PrescriptionCard(rx: filteredRx[i]),
                ),
              ),
            ],
          ),
