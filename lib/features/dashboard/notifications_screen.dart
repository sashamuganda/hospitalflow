...
class _NotificationsScreenState extends State<NotificationsScreen> {
  ...
  Widget build(BuildContext context) {
    // ⚡ Bolt: Single-pass to collect both filtered list and global unread count.
    // This avoids O(N*M) complexity when accessing the getter multiple times,
    // especially inside the ListView.itemBuilder.
    int unreadCount = 0;
