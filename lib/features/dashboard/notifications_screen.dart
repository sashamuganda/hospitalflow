...
class _NotificationsScreenState extends State<NotificationsScreen> {
  ...
  Widget build(BuildContext context) {
    // ⚡ Bolt: Cache filtered notifications and unread count in local variables to avoid redundant O(N) filtering
    // when accessed multiple times during a single build cycle.
