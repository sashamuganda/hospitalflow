...
class _NotificationsScreenState extends State<NotificationsScreen> {
  ...
  Widget build(BuildContext context) {
    // ⚡ Bolt: Consolidate unread count and filtering into a single O(N) pass to avoid multiple list traversals
    // This also fixes O(N*M) complexity in the ListView builder by caching the filtered list in a local variable.
    ...
    for (final n in mockNotifications) {
      ...
      if (filterLower == 'all' || n.type.toLowerCase() == filterLower) {
        filtered.add(n);
      }
    }
