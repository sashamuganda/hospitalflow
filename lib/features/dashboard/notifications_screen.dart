...
class _NotificationsScreenState extends State<NotificationsScreen> {
  ...
  Widget build(BuildContext context) {
    // ⚡ Bolt: Cache filtered results and hoist query transformation to avoid O(N^2) complexity in builders
    final fLower = _filter.toLowerCase();
    final filtered = _filter == 'All'
        ? mockNotifications
        : mockNotifications
            .where((n) => n.type.toLowerCase() == fLower)
            .toList();
