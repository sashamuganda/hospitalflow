...
class _QueueHomeScreenState extends State<QueueHomeScreen> {
  ...
  Widget build(BuildContext context) {
    // ⚡ Bolt: Consolidated multiple O(N) traversals (filtering, waiting/immediate counts,
    // and triage breakdown) into a single O(N) pass to improve performance and reduce allocations.
