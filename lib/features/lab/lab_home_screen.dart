...
class _LabHomeScreenState extends State<LabHomeScreen> {
  ...
  Widget build(BuildContext context) {
    // ⚡ Bolt: Cache sorted orders to avoid redundant O(N log N) sorting operations
    // multiple times per build cycle (specifically once for itemCount and once
    // for each visible item in itemBuilder).
