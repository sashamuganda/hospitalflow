...
class _LabHomeScreenState extends State<LabHomeScreen> {
  ...
  Widget build(BuildContext context) {
    // ⚡ Bolt: Cache sorted orders in a local variable to avoid O(N log N) sorting
    // multiple times per frame (once for itemCount and once per visible item in itemBuilder).
            ...
            children: [
              ...
              Expanded(
                child: ListView.separated(
                  ...
                  itemBuilder: (context, i) => _LabOrderCard(order: sorted[i]),
                ),
              ),
            ],
          ),
