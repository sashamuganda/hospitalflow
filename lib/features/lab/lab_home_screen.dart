...
class _LabHomeScreenState extends State<LabHomeScreen> {
  ...
  Widget build(BuildContext context) {
    // ⚡ Bolt: Cache sorted list and optimize sorting to avoid O(N*M log N) complexity in ListView
    const weights = {'stat': 0, 'urgent': 1};
    final sortedOrders = List<LabOrder>.from(mockLabOrders)
      ..sort((a, b) {
        final wA = weights[a.priority.toLowerCase()] ?? 2;
        final wB = weights[b.priority.toLowerCase()] ?? 2;
