...
class _LabHomeScreenState extends State<LabHomeScreen> {
  ...
  void initState() {
    super.initState();
    // ⚡ Bolt: Perform heavy sorting in initState to avoid O(N log N) complexity in build.
    // This reduces build complexity from O(N log N) to O(1) for all subsequent rebuilds.
