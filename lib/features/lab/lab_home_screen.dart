...
class _LabHomeScreenState extends State<LabHomeScreen> {
  ...
  Widget build(BuildContext context) {
    // ⚡ Bolt: Cache sorted results in a local variable to avoid redundant O(N log N)
    // sorting and list allocations when accessed for itemCount and inside itemBuilder.
