...
class _LabHomeScreenState extends State<LabHomeScreen> {
  ...
  Widget build(BuildContext context) {
    // ⚡ Bolt: Cache sorted list in local variable to avoid O(N*M log N) complexity
    // where N is total items and M is visible items. This avoids redundant sorting
    // and list allocations on every frame.
