...
class _LabHomeScreenState extends State<LabHomeScreen> {
  ...
  Widget build(BuildContext context) {
    // ⚡ Bolt: Cache sorted orders in a local variable to prevent O(M * N log N) complexity.
    // Calling the getter inside the itemBuilder would trigger a sort on every item render.
