...
class _LabHomeScreenState extends State<LabHomeScreen> {
  ...
  Widget build(BuildContext context) {
    // ⚡ Bolt: Cache sorted orders to avoid O(M * N log N) complexity where N is total items
    // and M is visible items, by preventing redundant sorting for each list item.
