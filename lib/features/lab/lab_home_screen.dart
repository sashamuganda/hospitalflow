...
class _LabHomeScreenState extends State<LabHomeScreen> {
  ...
  Widget build(BuildContext context) {
    // ⚡ Bolt: Cache sorted list in a local variable to avoid redundant O(N log N) sorting
    // operations and multiple list allocations during the build cycle (called for itemCount and every itemBuilder).
