...
class _LabHomeScreenState extends State<LabHomeScreen> {
  ...
  Widget build(BuildContext context) {
    // BOLT OPTIMIZATION: Cache sorted list to avoid O(N log N) sorting on every item build.
    // This reduces complexity from O(M * N log N) to O(N log N) per frame, where M is number of visible items.
