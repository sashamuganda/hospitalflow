...
class _EmrHomeScreenState extends State<EmrHomeScreen> {
  ...
  Widget build(BuildContext context) {
    // ⚡ Bolt: Cache filtered results in a local variable to avoid O(M * N) complexity
    // where N is total records and M is visible items. This also prevents redundant
    // string lowercasing and contains() checks on every item builder call.
