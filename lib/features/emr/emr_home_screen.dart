...
class _EmrHomeScreenState extends State<EmrHomeScreen> {
  ...
  Widget build(BuildContext context) {
    // ⚡ Bolt: Cache search results in local variable to avoid redundant O(N) filtering
    // when accessed multiple times (results count, empty check, and ListView) during a single build cycle.
