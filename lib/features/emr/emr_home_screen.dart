...
class _EmrHomeScreenState extends State<EmrHomeScreen> {
  ...
  Widget build(BuildContext context) {
    // ⚡ Bolt: Cache search results once per build to avoid O(N) operations during ListView.itemBuilder calls.
    // Hoisting toLowerCase() outside the where closure also improves efficiency.
