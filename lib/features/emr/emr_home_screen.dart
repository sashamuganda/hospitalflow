...
class _EmrHomeScreenState extends State<EmrHomeScreen> {
  ...
  Widget build(BuildContext context) {
    // Cache filtered results to avoid re-filtering on every list item build
          ...
          child: Column(
            children: [
              ...
              if (_query.isEmpty) ...[
                ...
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 20),
                  child: Text('${searchResults.length} results for "$_query"',
                ...
                child: searchResults.isEmpty
                    ...
                    : ListView.separated(
                        ...
                        itemBuilder: (context, i) => _PatientRecordCard(
                          patient: searchResults[i],
                          onTap: () =>
                              context.push('/emr/patient/${searchResults[i].id}'),
                        ),
                      ),
              ),
            ],
