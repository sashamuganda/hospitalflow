...
class _StaffAppointmentsHomeState extends State<StaffAppointmentsHome> {
  ...
  Widget build(BuildContext context) {
    // ⚡ Bolt: Cache filtered appointments in local variable to avoid O(N^2) complexity in ListView.separated
    final filteredAppts = _filtered;
              ...
              Expanded(
                child: ListView.separated(
                  ...
                  itemBuilder: (context, i) =>
                      _AppointmentCard(appointment: filteredAppts[i]),
                ),
              ),
            ],
          ),
